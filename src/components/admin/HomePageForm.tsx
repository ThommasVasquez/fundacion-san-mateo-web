...
import { Save, Image as ImageIcon, FileText, CheckCircle, Loader2 } from 'lucide-react';
...
// Estructura de campos agrupados y tipos
export const homePageFields = [
  ...
  { group: 'Sección Valores (¿Por Qué Elegirnos?)', key: 'home_why_subtitle', label: 'Subtítulo', type: 'text', default: 'Nuestra Identidad' },
  { group: 'Sección Valores (¿Por Qué Elegirnos?)', key: 'home_why_title', label: 'Título', type: 'text', default: 'VALORES QUE <br /><span class="text-fsm-red">TRANSFORMAN</span>' },
  { group: 'Sección Valores (¿Por Qué Elegirnos?)', key: 'home_why_quote', label: 'Cita Principal', type: 'text', default: '"Formamos con vocación y excelencia técnica, integrando principios éticos y humanistas en cada paso de nuestro proceso educativo."' },

  { group: 'Sección Testimonios', key: 'home_test_subtitle', label: 'Subtítulo', type: 'text', default: 'Testimonios' },
  { group: 'Sección Testimonios', key: 'home_test_title', label: 'Título Principal', type: 'text', default: 'VOCES DE NUESTROS EGRESADOS' }
];
...
export default function HomePageForm({ initialContent }: HomePageFormProps) {
  ...
  const handleUpdate = async (key: string, newValue: string, type: string) => {
    ...
    // updateContent (contentKey, newValue, pagePath, contentType)
  ...
  // Group by section
  const groupedFields = homePageFields.reduce((acc, field) => {

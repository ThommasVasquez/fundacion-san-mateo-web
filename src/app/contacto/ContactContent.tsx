...
import { ChevronRight, Send, Phone, Home, Mail, MessageSquare, Headphones } from "lucide-react";
          ...
          <div className="max-w-xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[10px] font-black tracking-[0.4em] text-fsm-red uppercase">
                {content.contact_hero_subtitle || "Atención Directa"}
              </span>
            </div>
            <h1 className="text-5xl md:text-7xl font-black text-fsm-blue leading-none mb-8">
              {content.contact_hero_title1 || "ESTAMOS"} <br />
              <span className="text-fsm-blue-light uppercase">{content.contact_hero_title2 || "Contigo"}</span>
            </h1>
            <p className="text-lg text-gray-700 font-medium leading-relaxed">
              {content.contact_hero_description || "Resuelva sus dudas de manera personalizada. Nuestro equipo está listo para asesorarle en su camino hacia la excelencia técnica."}
            </p>
          </div>
        </div>
        <div className="lg:w-1/2 relative min-h-[300px] lg:min-h-full overflow-hidden bg-fsm-blue">
          <Image
            src={content.contact_hero_image || "/img/banner16.jpg"}
            alt="Contacto FSM"
            fill
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
          ...
          <div className="reveal-item lg:col-span-7 bg-gray-50/50 p-10 md:p-16 rounded-[4rem] border border-gray-100 shadow-sm relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-black text-fsm-blue mb-10 uppercase tracking-tighter">
                {content.contact_form_title || "Consulta Digital"}
              </h2>
              ...
              <div className="space-y-10 relative z-10">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-sm leading-relaxed mb-1">{content.contact_addr_academic || "Calle 19 # 7A - 29 Soacha"}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-sm leading-relaxed mb-1">Sede Administrativa: {content.contact_addr_admin || "Calle 19 #8-21"}</p>
                    <p className="font-bold text-sm leading-relaxed"></p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-black tracking-tighter">{content.contact_phone_main || "(601) 732 1080"}</p>
                    <p className="text-sm font-bold opacity-60">{content.contact_phone_sec || "(601) 817 5456"}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-black text-sm lowercase tracking-tighter">{content.contact_email || "info@fundacionsanmateosoacha.edu.co"}</p>
                  </div>
                </div>
              </div>
            </div>

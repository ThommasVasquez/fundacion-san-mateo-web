            ...
            <section className="reveal-content">
              <div className="mb-8">
                ...
                <p className="text-3xl md:text-4xl font-black text-fsm-blue leading-tight uppercase font-display">
                   ...
                   <span className="text-fsm-blue">VOCACIÓN DE SERVIR</span>
                </p>
              </div>
                ...
                <div className="relative z-10">
                         ...
                         <div className="flex flex-col gap-6">
                            <div className="p-8 bg-white rounded-3xl border border-gray-100 shadow-sm flex gap-6">
                               ...
                               <div>
                                  ...
                                  <p className="text-sm text-gray-900 font-medium">Resolución No. 1066 del 1 de junio de 2022 - Secretaría de Educación de Soacha.</p>
                               </div>
                            </div>
                            <div className="p-8 bg-white rounded-3xl border border-gray-100 shadow-sm flex gap-6">
                               ...
                               <div>
                                  ...
                                  <p className="text-sm text-gray-900 font-medium">Programa acreditado bajo las normas NTC 5555 e ISO 9001:2015.</p>
                               </div>
                            </div>
                         </div>
                      </div>
                   ...
                   {activeTab === "practicas" && (
                      <div className="space-y-12">
                         ...
                         <p className="text-gray-900 font-medium italic">Convenios con las mejores IPS y hospitales de la región para garantizar tu aprendizaje práctico.</p>
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-32 space-y-8">
              ...
              <div className="p-10 bg-gray-50 rounded-[4rem] border border-gray-100 flex flex-col items-center text-center">
                 ...
                 <p className="text-[10px] font-black text-gray-700 tracking-[0.2em] uppercase">Por tiempo limitado</p>
              </div>
            </div>
          </div>
        </div>

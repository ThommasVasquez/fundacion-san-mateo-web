          ...
          <div className="max-w-xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[10px] font-black tracking-[0.4em] text-fsm-red uppercase">
                {getC('about_hero_subtitle', 'Nuestra Institución')}
              </span>
            </div>
            <h1 
              className="text-5xl md:text-7xl font-black text-fsm-blue leading-none mb-8"
              dangerouslySetInnerHTML={{ __html: getC('about_hero_title', 'CONOCE LA <br /> <span class="text-fsm-blue-light uppercase">Historia</span>') }}
            />
            <p className="text-lg text-gray-700 font-medium leading-relaxed">
              {getC('about_hero_desc', 'Más de dos décadas transformando vidas a través de la educación técnica de calidad en el municipio de Soacha.')}
            </p>
          </div>
        </div>
        <div className="lg:w-1/2 relative min-h-[300px] lg:min-h-full overflow-hidden bg-fsm-blue">
          <Image 
            src={getC('about_hero_image', '/img/banner32.jpg')} 
            alt="Acerca de FSM" 
            fill 
          ...
          <section className="reveal-section flex flex-col lg:flex-row gap-20 items-center">
            <div className="lg:w-1/2 relative">
               <div className="relative h-[600px] w-full rounded-[4rem] overflow-hidden shadow-premium z-10 border border-gray-100">
                  <Image 
                    src={getC('about_history_image', '/img/image4.png')} 
                    alt="Historia FSM" 
                    fill 
                    className="parallax-img object-cover scale-125 transition-transform duration-700 hover:scale-100" 
                  />
               </div>
            </div>
            ...
            <div className="lg:w-1/2 space-y-10">
              <div className="flex items-center gap-4 text-fsm-red">
                ...
                <h2 className="text-4xl font-black text-fsm-blue uppercase tracking-tighter">
                  {getC('about_history_title', 'Nuestra Trayectoria')}
                </h2>
              </div>
              <div className="space-y-8 text-xl text-gray-700 font-medium leading-relaxed text-balance">
                <p>{getC('about_history_p1', 'La FUNDACIÓN SAN MATEO nació en noviembre del año 2000 como una respuesta valiente a las crecientes necesidades educativas de las comunidades en riesgo de Soacha.')}</p>
                <p>{getC('about_history_p2', 'Desde el barrio San Mateo, iniciamos formando Promotores de Salud, evolucionando hasta convertirnos en la institución líder en formación de Técnicos Laborales que somos hoy, capacitándonos para interactuar con excelencia en el mercado laboral real.')}</p>
                ...
                <div className="p-10 bg-gray-50 rounded-[3rem] border border-gray-100 relative overflow-hidden group">
                   ...
                   <p className="text-base text-fsm-blue leading-relaxed font-bold italic relative z-10">
                    {getC('about_history_quote', '"Cumplimos una labor social vital, empoderando a jóvenes y adultos para transformar su realidad socioeconómica."')}
                   </p>
                </div>
              </div>
              ...
              <div className="pt-10 border-t border-gray-100 reveal-section">
                ...
                <h3 className="text-3xl font-black text-fsm-blue uppercase tracking-tighter mb-6">
                  {getC('about_cert_title', 'Excelencia Acreditada')}
                </h3>
                <p className="text-lg text-gray-700 font-medium leading-relaxed mb-10">
                  {getC('about_cert_desc', 'Nuestra institución está comprometida con los más altos estándares educativos. Contamos con certificaciones ISO que garantizan la calidad en todos nuestros procesos administrativos y pedagógicos.')}
                </p>
          ...
          <div className="reveal-section grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="group bg-fsm-blue rounded-[5rem] p-16 text-white shadow-premium relative overflow-hidden transition-all duration-700 hover:-translate-y-4">
              ...
              <h2 className="text-4xl font-black mb-8 uppercase tracking-tighter leading-none">
                {getC('about_mission_title', 'Misión')}
              </h2>
              <p className="text-xl text-white/60 leading-relaxed font-medium">
                {getC('about_mission_desc', 'Formar integralmente a nuestros estudiantes mediante programas técnicos con alto nivel de exigencia y competitividad, orientados por un talento humano idóneo y el mejoramiento continuo institucional.')}
              </p>
            </div>
            ...
            <div className="group bg-gray-50 rounded-[5rem] p-16 text-fsm-blue shadow-premium relative overflow-hidden transition-all duration-700 hover:-translate-y-4 border border-gray-100">
              ...
              <h2 className="text-4xl font-black mb-8 uppercase tracking-tighter leading-none">
                {getC('about_vision_title', 'Visión')}
              </h2>
              <p className="text-xl text-gray-700 leading-relaxed font-medium">
                {getC('about_vision_desc', 'Ser reconocidos en todo Cundinamarca por la excelencia educativa, compromiso social y el liderazgo en la formación técnica certificada bajo rigurosos sistemas de gestión de calidad.')}
              </p>
            </div>
          </div>
          ...
          <div className="reveal-section bg-fsm-red p-16 md:p-24 rounded-[5rem] text-center relative overflow-hidden text-white shadow-premium transition-all duration-500">
             ...
             <div className="relative z-10 space-y-12">
                ...
                <div className="min-h-[180px] flex flex-col justify-center transition-opacity duration-500">
                  {selectedNorm === null ? (
                    <div>
                      <h3 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tighter leading-none mb-6">
                        {getC('about_norms_title', 'Excelencia Acreditada')}
                      </h3>
                      <p 
                        className="max-w-4xl mx-auto text-xl md:text-2xl text-white/70 font-light leading-relaxed"
                        dangerouslySetInnerHTML={{ __html: getC('about_norms_desc', 'Contamos con certificaciones internacionales <span class="text-white font-black underline decoration-white/30 decoration-wavy underline-offset-8">ISO 9001:2015</span> y Normas Técnicas de Calidad (NTC) que avalan nuestra trayectoria ininterrumpida desde el año 2000.') }}
                      />
                    </div>
                  ) : (
                    <div>

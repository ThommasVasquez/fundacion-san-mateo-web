...
import { ChevronRight, GraduationCap, BookOpen, UserPlus, ArrowRight } from "lucide-react";
...
export default function AcademicOfferContent({ initialPrograms, content }: AcademicOfferContentProps) {
  ...
  const filteredPrograms = initialPrograms.filter(p => p.category === activeTab);
          ...
          <div className="inline-flex p-1.5 bg-gray-50 rounded-full border border-gray-100 shadow-inner">
            <button
              ...
              className={cn(
                ...
                activeTab === "tecnicos" ? "bg-fsm-blue text-white shadow-lg" : "text-gray-700 hover:text-fsm-blue"
              )}
            >
          ...
          {activeTab === "tecnicos" ? (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 h-full">
              {filteredPrograms.map((program) => (
                ...
                >
                  <Image src={program.image_url} alt={program.title} fill className="object-cover transition-transform duration-1000 group-hover:scale-110" />
              ...
              {filteredPrograms.map((program) => (
                ...
                >
                  ...
                  <div className="relative h-72 pointer-events-none">
                    <Image src={program.image_url} alt={program.title} fill className="object-cover transition-transform duration-1000 group-hover:scale-110 group-hover:grayscale-0" />
                  ...
                  <div className="p-10 relative z-10 pointer-events-none flex-grow flex flex-col">
                    ...
                    <div className="flex items-center justify-between mt-auto pointer-events-auto">
                      ...
                      <a 
                        href={content['navbar_inscripciones_link'] || "https://fundacionsanmateosoacha.escalapages.com/centro-de-ventas"}
                        target="_blank"
